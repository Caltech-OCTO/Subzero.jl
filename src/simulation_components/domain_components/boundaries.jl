...
OpenBoundary{South, Float32}
  ⊢polygon points are defined by the following set: (-250000.0f0, -250000.0f0), (750000.0f0, 0.0f0), (-250000.0f0, 0.0f0), (750000.0f0, -250000.0f0)
  ∟val is 0.0
```
"""
...
PeriodicBoundary{East, Float64}
  ⊢polygon points are defined by the following set: (750000.0, 750000.0), (500000.0, 750000.0), (750000.0, -250000.0), (500000.0, -250000.0)
  ∟val is 500000.0
```
...
PeriodicBoundary{West, Float64}
  ⊢polygon points are defined by the following set: (0.0, 750000.0), (-250000.0, -250000.0), (-250000.0, 750000.0), (0.0, -250000.0)
  ∟val is 0.0
```
"""
...
CollisionBoundary{West, Float32}
  ⊢polygon points are defined by the following set: (0.0f0, 750000.0f0), (-250000.0f0, -250000.0f0), (-250000.0f0, 750000.0f0), (0.0f0, -250000.0f0)
  ∟val is 0.0
```
"""
