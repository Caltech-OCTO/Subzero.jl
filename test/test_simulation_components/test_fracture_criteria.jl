...
@testset "Fracture Criteria" begin
    ...
    hibler_a, hibler_b, hibler_h, hibler_poly = Subzero._calculate_hibler(FT, 0.5, 5e5, -1)
    ...
    hibler_a, hibler_b, hibler_h, hibler_poly = Subzero._calculate_hibler(FT, 0.25, 2.25e5, 20.0)
    hibler_verts = Subzero.find_poly_coords(hibler_poly)
