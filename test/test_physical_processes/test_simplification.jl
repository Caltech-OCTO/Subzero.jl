@testset "Simplification" begin
    ...
    @testset "Smooth Floes" begin
        ...
        @test sum(GO.area, Subzero.intersect_polys(LG.Polygon(floe_set2.coords[1]), LG.Polygon(open_domain_with_topo.topography.coords[1])); init = 0.0) == 0
        
        @test GO.area(LG.Polygon(floe_set2.coords[1])) > 2og_f1_area/3
