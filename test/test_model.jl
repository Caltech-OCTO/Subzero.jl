@testset "Model Creation" begin
    ...
    @testset "Boundary and Domain" begin
        ...
        rdomain1 = Subzero.Domain(b4, b1, b3, b2)
        @test rdomain1.north == b4
        @test rdomain1.south == b1
        @test rdomain1.east == b3

        # RectangularDomain fails
        @test_throws ArgumentError Subzero.Domain(b1, b4, b3, b2)
        @test_throws ArgumentError Subzero.Domain(b4, b1, b2, b3)
        @test_throws ArgumentError Subzero.Domain(b4, b1, b2, b2)
